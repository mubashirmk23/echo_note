...
class Echonotepage2exampl extends StatefulWidget {
  const Echonotepage2exampl({super.key});

  @override
  State<Echonotepage2exampl> createState() => _Echnotepage2State();
}

class _Echnotepage2State extends State<Echonotepage2exampl> {
